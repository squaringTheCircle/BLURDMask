...
def get_parameters():
    ...
    parser.add_argument("--top_save_num", type=int, default=10)
    ...
    # Path
    parser.add_argument(
        "--img_path", type=str, default="./Data_preprocessing/train_img"
    )
    parser.add_argument(
        "--label_path", type=str, default="./Data_preprocessing/train_label"
    )
    parser.add_argument(
        "--val_img_path", type=str, default="./Data_preprocessing/val_img"
    )
    parser.add_argument(
        "--val_label_path", type=str, default="./Data_preprocessing/val_label"
    )
    parser.add_argument("--log_path", type=str, default="./logs")
    parser.add_argument("--model_save_path", type=str, default="./models")
    parser.add_argument("--sample_path", type=str, default="./samples")
    parser.add_argument(
        "--test_image_path", type=str, default="./Data_preprocessing/test_img"
    )
    ...
    parser.add_argument(
        "--test_color_label_path", type=str, default="./test_color_visualize"
    )
    ...
    parser.add_argument("--stop_step", type=int, default=25)
